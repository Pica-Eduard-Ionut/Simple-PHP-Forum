...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
    ...
    echo "<center><input type='hidden' name='posttitle' value='$title'</center>";
    echo "<center><textarea name='reply' rows='3' cols='75' placeholder='Your reply'></textarea></center>
    <center><input type='submit' value='Submit reply'></center>";
    ?>
</form>
    </body>
    </html>